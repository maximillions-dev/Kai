...
import com.beer.app.sandbox.SessionShell
import com.beer.app.sandbox.openFileWithIntent
import com.beer.app.sandbox.resolveSandboxAbsolute
...
class AndroidSandboxController : SandboxController {
    ...
    override fun transcriptFor(sessionId: String): SnapshotStateList<com.beer.app.TerminalLine> = sandboxManager.transcriptFor(sessionId)
