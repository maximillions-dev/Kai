...
import com.beer.app.network.tools.ParameterSchema
...
import com.beer.app.notifications.declaresNotificationListener
import com.beer.app.sms.SmsReader
import com.beer.app.sms.SmsSender
import com.beer.app.sms.declaresReadSms
import com.beer.app.tools.CalendarPermissionController
import com.beer.app.tools.CalendarRepository
import com.beer.app.tools.CalendarResult
import com.beer.app.tools.CommonTools
import com.beer.app.tools.EmailTools
import com.beer.app.tools.HeartbeatTools
import com.beer.app.tools.NotificationHelper
import com.beer.app.tools.NotificationPermissionController
import com.beer.app.tools.NotificationResult
import com.beer.app.tools.NotificationTools
import com.beer.app.tools.OpenFileTool
import com.beer.app.tools.ProcessManagerTool
import com.beer.app.tools.SchedulingTools
import com.beer.app.tools.ShellCommandTool
import com.beer.app.tools.SmsTools
import com.beer.app.tools.WebSearchTool
...
actual fun createLegacySettings(): Settings? {
    val context: Context by inject(Context::class.java)
    val prefs = context.getSharedPreferences("com.beer.app_preferences", Context.MODE_PRIVATE)
