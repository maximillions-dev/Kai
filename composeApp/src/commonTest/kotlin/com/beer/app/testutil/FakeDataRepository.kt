package com.beer.app.testutil

import com.beer.app.data.Conversation
import com.beer.app.data.DataRepository
import com.beer.app.data.EmailAccount
import com.beer.app.data.EmailSyncState
import com.beer.app.data.FallbackStatus
import com.beer.app.data.FreeMode
import com.beer.app.data.HeartbeatConfig
import com.beer.app.data.HeartbeatLogEntry
import com.beer.app.data.ImportSection
import com.beer.app.data.MemoryEntry
import com.beer.app.data.ScheduledTask
import com.beer.app.data.Service
import com.beer.app.data.ServiceEntry
import com.beer.app.data.ServiceInstance
import com.beer.app.data.SmsDraft
import com.beer.app.data.SmsSyncState
import com.beer.app.data.SystemPromptVariant
...
class FakeDataRepository : DataRepository {
    ...
    override suspend fun ask(question: String?, files: List<PlatformFile>, uiSubmission: com.beer.app.data.UiSubmission?) {
    ...
    override fun getNotificationSyncState(): com.beer.app.data.NotificationSyncState = com.beer.app.data.NotificationSyncState()
