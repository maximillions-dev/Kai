...
import com.beer.app.BackIcon
import com.beer.app.data.Service
import com.beer.app.data.supportsAgenticFlows
import com.beer.app.getBackgroundDispatcher
import com.beer.app.onDragAndDropEventDropped
import com.beer.app.ui.chat.composables.BotMessage
import com.beer.app.ui.chat.composables.ChatHistorySheet
import com.beer.app.ui.chat.composables.CircleIconButton
import com.beer.app.ui.chat.composables.EmptyState
import com.beer.app.ui.chat.composables.ErrorMessage
import com.beer.app.ui.chat.composables.HeartbeatBanner
import com.beer.app.ui.chat.composables.PendingSmsBanners
import com.beer.app.ui.chat.composables.QuestionInput
import com.beer.app.ui.chat.composables.ServiceSelector
import com.beer.app.ui.chat.composables.TopBar
import com.beer.app.ui.chat.composables.TrailingIcon
import com.beer.app.ui.chat.composables.UserMessage
import com.beer.app.ui.chat.composables.WaitingResponseRow
import com.beer.app.ui.chat.composables.uiErrorText
...
private fun InteractiveModeScreen(uiState: ChatUiState) {
    ...
    com.beer.app.PlatformBackHandler(enabled = true) {
    ...
    Box(
        ...
        if (!showFullInput) {
            val gradientBrush = com.beer.app.ui.gradientBrush
            Row(
                modifier = Modifier
